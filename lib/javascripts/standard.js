    ...
    if (!tstSearchPage) {
        if(tstFormElements[i].getAttribute("ajaxURL") != null){
            ...
            if(tstFormElements[i].tagName == "SELECT") {
                ...
                if(tstFormElements[i].getAttribute("dualView") != null &&
                    tstFormElements[i].getAttribute("dualViewOptions") != null) {

                    loadSelectOptions(selectOptions, options, eval(tstFormElements[i].getAttribute("dualViewOptions")));
...
function loadSelectOptions(selectOptions, options, dualViewOptions) {
    ...
    if(dualViewOptions != undefined) {
        tstDualViewOptions = dualViewOptions;
    ...
    validateSelectOptions: function() {
        ...
        if (tagName == "SELECT" || suggestURL != "" && allowFreeText != "true") {
            ...
            if (this.formElement.tagName == "SELECT") {
                ...
                selectOptions = __$("options").getElementsByTagName("LI");
