...
function generateHomepage(){
    ...
    datenow = datenow.getDate() + "-" + months[(datenow.getMonth() + 1)] + "-" + datenow.getFullYear();
    ...
    login.innerHTML = "<b>Date:</b> " + (__$("date") ? current_date : datenow) + "<br /><div id='user'>" +
...
function shiftLayer(layer, parent) {
    var row = layer;
    var currentlayer = (layer.id == "tabContainer2" ? "tabContainer2" : "tabContainer")

    if(/*__$(currentlayer).innerHTML.trim().length > 0 && */tabSelected == true){
